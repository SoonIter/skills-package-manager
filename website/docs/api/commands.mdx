...
Install all skills defined in `skills.json`, and synchronize `skills-lock.yaml`, `installDir`, `linkTargets`, and any auto-discovered self skill enabled by `selfSkill`.

...
Install all skills defined in `skills.json`, and synchronize `skills-lock.yaml`, `installDir`, `linkTargets`, and the bundled `skills-package-manager-cli` self skill when `selfSkill` is enabled.
